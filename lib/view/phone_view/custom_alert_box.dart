...
void showAlert({@required BuildContext context, String alert, String description, String defaultButtonName, String optionalButtonName, Color optionalButtonColor, Function onPressOptionalButton}) {
  ...
  showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return Dialog(
          ...
          child: Container(
            width: kIsWeb ? size.width/3 : size.width/2,
                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              alert,
                              style: TextStyle(color: Color(0xff525b75), fontWeight: FontWeight.w600, fontSize: 18.0),
                            ),
                            Flexible(
                                child: Padding(
